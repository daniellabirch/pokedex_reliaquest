  ...
  for (const key in defaultProps2) {
    if (Object.prototype.hasOwnProperty.call(defaultProps2, key)) {
      ...
      if (propName === "components" || propName === "slots") {
        ...
        output.className = clsx_default3(defaultProps2 == null ? void 0 : defaultProps2.className, props == null ? void 0 : props.className);
...
function useCurrentColorScheme(options) {
  ...
  const modeStorage = React26.useMemo(() => storageManager == null ? void 0 : storageManager({
    key: modeStorageKey,
    storageWindow
  }), [storageManager, modeStorageKey, storageWindow]);
  const lightStorage = React26.useMemo(() => storageManager == null ? void 0 : storageManager({
    key: `${colorSchemeStorageKey}-light`,
    storageWindow
  }), [storageManager, colorSchemeStorageKey, storageWindow]);
  const darkStorage = React26.useMemo(() => storageManager == null ? void 0 : storageManager({
...
@mui/system/esm/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-2FCDN2BP.js.map
